    ...
    function changeType(e) {
        ...
        setProjects(
            PROJECTS.filter((project) => {
                ...
                console.log(e.target.value);
                if (
                    project.categories.indexOf(e.target.value) >= 0 ||
                    project.languages.indexOf(e.target.value) >= 0
                )
                    return true;
                return false;
            })
    ...
    return (
        <div className="row app_projects_bar">
            <div className="col-12 ">
                ...
                <h5 className="text-white p-2 pr-3 text-right">
                    {" "}
                    <span className="pr-3"> Filter </span>
                    <select
                        className="app_project_filter"
                            ...
                            <div className="col-sm-6 mb-2 mt-2 app_project_card">
                                <div className="card h-100 text-black bg-light">
                                    <div className="card-body">
                                        <h5 className="card-title app_project-title">
                                            {project.name}
                                        </h5>
                                        <p className="card-text">
                                            {project.description}
                                        </p>
                                        <h6 className="app_project-title">
                                            Written in:
                                        </h6>
