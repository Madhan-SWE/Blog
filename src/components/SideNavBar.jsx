...
export default function SideNavBar() {
    return (
        <div className="col-lg-3 app_sidebar text-center text-white bg-dark">
            ...
            <img
                src={avatar}
                class="img-fluid rounded m-3 avatar"
                width="200px"
                height="200px"
            ...
            <div className="row">
                <div className="col-12 text-center">
                    ...
                    <div>
                        <i class="fas fa-phone-alt app_contact pr-3 mb-2"></i>
                        <span className="app_contact">
                            {" "}
                            +91-8110805088
                        </span>{" "}
                        <br />
                        <i class="fas fa-envelope app_contact  pr-3 mb-2"></i>{" "}
                        <span className="app_contact">
                            {" "}
                            rcmadhankumar@gmail.com
                        </span>{" "}
                        <br />
                        <i class="fas fa-map-marker-alt  pr-3 app_contact mb-2"></i>{" "}
                        <span className="app_contact"> Bangalore, India </span>{" "}
                        <br />
                    </div>
                    <a
                        href={resume}
                        download="Madhankumar-SoftwareDeveloper-Resume.pdf"
                    >
                        <button
                            type="button"
